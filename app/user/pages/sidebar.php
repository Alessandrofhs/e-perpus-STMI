<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            ...
            // Assuming the profile picture URL is stored in the 'profile_picture' field
            $id_user = $_SESSION['id_user'];
            $userQuery = mysqli_query($koneksi, "SELECT profile_picture FROM user WHERE id_user = '$id_user'");
            ...
            <div class="pull-left image">
                ...
                if (!empty($profilePicture)) {
                    // If the profile picture is available, display it
                    echo '<img src="../../assets/dist/img' . $profilePicture . '" class="img-circle" alt="User Image">';
                } else {
                    // If no profile picture, display a default avatar
