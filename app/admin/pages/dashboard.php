...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="alert alert-secondary" style="color: #383d41; background-color: #e2e3e5; border-color: #d6d8db;">
            Selamat Datang, <?= $_SESSION['fullname']; ?> di Administrator Perpustakaan Politeknik STMI Jakarta.
        </div>
        ...
        <div class="row">
            ...
            <img src="../../assets/dist/img/stmi-logo.png" width="120px" height="120px"
                style="display: block; margin-left: auto; margin-right: auto; margin-top: 30px; margin-bottom: -20px;">

            <h2 class="text-center" style="font-family: Quicksand, sans-serif;">Perpustakaan Politeknik STMI Jakarta
            </h2>
            <p class="text-center">Alamat : Jl. Letjen Suprapto No.26, RW.5, Cemp. Putih Tim., Kec. Cemp. Putih, Kota
                Jakarta Pusat, Daerah Khusus Ibukota Jakarta 10510</p>
