...
<head>
    ...
    <!-- Icon -->
    <link rel="icon" type="icon" href="assets/dist/img/stmi-logo.png">
    <!-- Custom -->
...
<body class="hold-transition login-page" style="font-family: 'Quicksand', sans-serif;">
    <div class="login-box">
        <div class="login-logo">
            <a href="masuk"><b>PERPUSTAKAAN DIGITAL</b></a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body" style="border-radius: 10px;">
            <img src="assets/dist/img/stmi-logo.png" height="80px" width="80px"
